...
const HomeScreenSectionTrackBookingRoom: React.FC<any> = () => {
  ...
  return (
    ...
    >
      <View style={styles.wrapper}>
        ...
        <Text style={styles.text}>Track for booking requests</Text>
      </View>
    </TouchableOpacity>
  );
};
...
export default HomeScreenSectionTrackBookingRoom;
